...
<div class="pagecontent">
	<div id="submaincontent" class="clearfix">
		...
		<p>Click any of the badges below for information on how to earn those badges!</p>
     	...
     	<div id="web_badges" class="badgecontainer">
			<h2>Web</h2>
			<ul class="badgeList">
				<li>
					<div class="badgeTile"><a href="/tutorials/tutorial.php"><img src="/assets/img/badge_thumb.jpg" /></a></div>
					<div class="badgeInfo">
						<h2><a href="/tutorials/tutorial.php">Build AYummy Hamburger With HTML</a></h2>
						<a href="/tutorials/tutorial.php">Get this Badge!</p></a>
						<div class="badgeCareer">
							<p>
     	...
     	<div id="game_badges" class="badgecontainer">
			<h2>Game</h2>
			<ul class="badgeList">
				<li>
					<div class="badgeTile"><a href="/tutorials/tutorial.php"><img src="/assets/img/badge_thumb.jpg" /></a></div>
     	...
     	<div id="film_badges" class="badgecontainer">
			<h2>Film</h2>
			<ul class="badgeList">
				<li>
					<div class="badgeTile"><a href="/tutorials/tutorial.php"><img src="/assets/img/badge_thumb.jpg" /></a></div>
...
<script type="text/x-jsrender" id="badgeItemTemplate">
	<li>
		<div class="badgeTile"><a href="{{:TUTORIAL_LINK}}"><img src="{{:BADGE_IMAGE}}" /></a></div>
		<div class="badgeInfo">
